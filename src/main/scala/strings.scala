...
object strings {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //length
    val l = hello.length
    println("the string is : " + hello + " and has " + l  + " chars")
    //concatenate
    val s = "hello"
    val h = " world"
    val c = s + h
    ...
    println("finish: " + str5)
    //split
    val str6 = "hello world everybody".split(" ").foreach(println)
    //string interpolation
    val name = "javier"
    val age = "25"
    val size = 1.90
    println(s"my name is $name and I am $age years old and $size.2f tall")
    //with decimals
    println(f"my name is $name and I am $age years old and $size%.2f tall")
    ...
    val str8 = "number 256 in Oxford street 78".replaceAll("[0-9]", "j")
    println(str8)
